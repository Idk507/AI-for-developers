...
### Section 01: Async & Await (`section_01_async_await.py`)
...
### Section 02: Threading (`section_02_threading.py`)
...
### Sections 03–05: Multiprocessing, Generators & Decorators (`section_03_04_05_multiprocessing_generators_decorators.py`)
...
* **4.2 Composing Generators** — `extract` $\rightarrow$ `clean` $\rightarrow$ `deduplicate` $\rightarrow$ `batch` (lazy chain)
...
### Sections 06–10: Advanced Topics (`section_06_to_10_advanced.py`)
